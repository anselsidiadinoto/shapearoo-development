export function DesignerOrderDetails() {
  return (
    <div className='w-[800px] mx-auto mt-10'>
      <div className='flex'>
        <div className='text-sm'>
          ...
          <div>12/24/2024</div>
          <div className='flex w-[300px] rounded-xl border-black border-[1.5px] h-36 p-4 mt-3'>
            <div className='flex w-80 flex-col mt-1'>
        ...
        <div className='mt-16 ml-5'>
          <div>Selected print shop</div>
          <div className='flex h-[100px] mt-3'>
            ...
            <div className='text-xs flex flex-col w-40 ml-3'>
              ...
              <div className='mt-1'>contact print shop</div>
            </div>
          </div>
        </div>
      </div>

      <div className='flex w-full text-sm h-6 border-b-[1px] border-black mb-1 mt-8'>
